/** Letterboxd, Goodreads, Instagram (paths from Simple Icons, MIT — https://simpleicons.org/) */

export function LetterboxdIcon({ className }: { className?: string }) {
    return (
        <svg
            role="img"
            viewBox="0 0 24 24"
...
export function InstagramIcon({ className }: { className?: string }) {
    return (
        <svg
            ...
            aria-hidden
        >
            {/* Simple Icons Instagram — single path, explicit separators (avoids parser glitches) */}
            <path
                fill="currentColor"
